...
- **Rich & Plain Paste**: Press `Enter` (or `1-0`) to strip formatting and paste plain text, hold `Cmd` to inject exact Rich Text formats with styles intact, or hold `Cmd + Option` to paste Rich Text with all hyperlinks cleanly stripped out. 
