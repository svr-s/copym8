...
- **Customizable Themes & Settings**: Personalize the glowing aesthetic (`Cmd + K`), set unpinned clipboard limits (up to 1,000 items), enforce maximum storage caps, and monitor real-time Storage Statistics (Total Items, Pinned Items, Memory Usage).
